...
const url = process.argv[2] || 'http://localhost:8126/journeyofgrace-site/journey-classes.html';
...
await p.screenshot({ path: '/tmp/opencode/jclasses-new-full.png', fullPage: true });
