...
const url = process.argv[2] || 'http://localhost:8126/journeyofgrace-site/life-groups.html';
...
await p.screenshot({ path: '/tmp/opencode/lifegroups-new-full.png', fullPage: true });
