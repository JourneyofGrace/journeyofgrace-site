...
const url = process.argv[2] || 'http://localhost:8126/journeyofgrace-site/service-teams.html';
...
await p.screenshot({ path: '/tmp/opencode/steams-new-full.png', fullPage: true });
