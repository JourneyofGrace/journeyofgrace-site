...
const url = process.argv[2] || 'http://localhost:8126/journeyofgrace-site/womens-ministry.html';
...
await p.screenshot({ path: '/tmp/opencode/womens-new-full.png', fullPage: true });
